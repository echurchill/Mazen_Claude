...
>
> **Deferred (future polish round, user-agreed):** the per-face day/night terminator in *orbit view* reads harsh — the lit face is a touch flat/over-bright and its boundary to the night face is a hard edge. A shading-softness pass (graded terminator, lower the lit max, a little bounce light on the dark side) — cosmetic, not structural. Also still open from the base plan: **M9 Phases 5–7** (moon-as-light, moon shadows, eclipses).
