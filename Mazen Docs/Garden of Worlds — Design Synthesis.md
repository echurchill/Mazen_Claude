...
*Merges Eddie's [Garden of Worlds concept](Source%20Material/The_Garden_of_Worlds_Game_Concept.md) + [inspirations](Source%20Material/The_Garden_of_Worlds_Game_Inspirations.md) with the [Goal Ideas whiteboard](Archive/Goal%20Ideas%20Whiteboard.md) and everything we've built (M8–M13). Drafted 2026-07-07 from the design conversation. This is the star everything else points at — not a spec.*
